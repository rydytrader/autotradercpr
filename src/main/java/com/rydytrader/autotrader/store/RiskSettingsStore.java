...
public class RiskSettingsStore {
    ...
    static class Cfg {
        ...
        /** When true, Camarilla.fire() rejects CE shorts in a STRONG_BULLISH_BIAS market and
         *  PE shorts in a STRONG_BEARISH_BIAS market — the bias must NOT oppose the trade
         ...
         *  filter is bypassed and only the budget gate sizes the trade. Default ON
        ...
        try {
            ...
            for (SettingEntity s : all) {
                ...
                switch (k) {
                    ...
                    // portfolioMaxRiskPct). camarillaMaxRisk + moveSlToBreakevenEnabled
                    // + camarillaVwapFilterEnabled were all removed in the v2 cleanup.
                    case "camarillaMaxRisk"             -> { /* retired — use portfolioMaxRiskPct */ }
