            ...
            for (SettingEntity s : all) {
                ...
                switch (k) {
                    ...
                    case "optionSellingEnabled",
                         ...
                         "optionSellingOrderType",
                         "optionSellingStartTime",
                         "optionSellingSquareOffTime",
                         "optionSellingMaxCeSellsPerDay",
                         "optionSellingMaxPeSellsPerDay"  -> { /* retired — silently consume legacy rows */ }
