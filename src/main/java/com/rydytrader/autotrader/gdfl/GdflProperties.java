 ...
 *
 * <p>Subscription happens DYNAMICALLY once {@code OptionBuying} resolves the day's ATM CE
...
public class GdflProperties {
    ...
    /** How often to poll {@code OptionBuying} for the resolved ATM. Once the CE/PE symbols
