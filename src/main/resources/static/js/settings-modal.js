                ...
                '<div class="sm-body" id="sm-body" style="flex:1;overflow-y:auto;padding:20px 24px;">' +
                  '<div class="sm-pane" data-pane="vwap-supertrend" style="display:none;">' +
                    '<div class="sm-grid-2col">' +
                      '<div class="sm-field sm-full"><label><input type="checkbox" id="sm-vwapStEnabled" style="margin-right:6px;vertical-align:middle;">Strategy enabled</label><div class="sm-hint">Master kill switch. Open positions keep managing when OFF.</div></div>' +
                      '<div class="sm-field"><label>Lots per Leg</label><input type="number" id="sm-vwapStLotsPerLeg" step="1" min="1"><div class="sm-hint">1 lot = 65 NIFTY.</div></div>' +
                  ...
                  '<div class="sm-pane" data-pane="charges" style="display:none;">' +
                    '<div class="sm-grid-2col">' +
                      '<div class="sm-field"><label>Brokerage per Order (₹)</label><input type="number" id="sm-brokeragePerOrder" step="1" min="0"><div class="sm-hint">Flat per-order.</div></div>' +
