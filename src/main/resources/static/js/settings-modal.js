              ...
              '<div style="background:var(--bg-card);border:1px solid var(--border);border-radius:12px;width:720px;max-width:94vw;max-height:88vh;display:flex;flex-direction:column;box-shadow:0 16px 48px rgba(0,0,0,0.3);">' +
                ...
                '<div class="sm-body" id="sm-body" style="flex:1;overflow-y:auto;padding:20px 24px;">' +
                  ...
                  '<div class="sm-pane" data-pane="portfolio-risk" style="display:none;">' +
                    ...
                    '<div class="sm-field"><label>Setup SL Buffer (NIFTY pts)</label><input type="number" id="sm-camarillaDirectionalSlBufferPoints" step="0.5" min="0" max="50"><div class="sm-hint">Widens stop-loss beyond the structural SL level by this many NIFTY spot points. Applies to all setups: directional (confirmation candle\'s extreme) and strangle (H4 / L4 Camarilla levels). Default 5.0; set to 0 to use the raw level / candle extreme.</div></div>' +
                  '</div>' +
