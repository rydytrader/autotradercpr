              ...
              '<div style="background:var(--bg-card);border:1px solid var(--border);border-radius:12px;width:720px;max-width:94vw;max-height:88vh;display:flex;flex-direction:column;box-shadow:0 16px 48px rgba(0,0,0,0.3);">' +
                ...
                '<div class="sm-body" id="sm-body" style="flex:1;overflow-y:auto;padding:20px 24px;">' +
                  '<div class="sm-pane" data-pane="camarilla" style="display:none;">' +
                    ...
                    '<div class="sm-field"><label><input type="checkbox" id="sm-camarillaMomentumCheckEnabled"> &nbsp;Momentum (RSI) Check</label><div class="sm-hint">When ON: each directional setup requires NIFTY RSI(14) to sit inside a setup-specific band — H4 breakout 50-80, L4 breakdown 20-40, reversals (H3/L3) 40-60. Filters out late-entry breakouts at exhaustion and reversals against a strong trend. When OFF: the momentum gate is skipped entirely. Default ON.</div></div>' +
